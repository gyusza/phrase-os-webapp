...
import FlashcardsClient from "@/components/practice/flashcards-client"
            ...
            <div className="space-y-3 sm:space-y-4 w-full">
              ...
              <div className="space-y-2">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                    <h1 className="text-3xl sm:text-4xl font-bold pt-1 italic text-primary">Flashcard study</h1>
                    {isFiltered && (
                ...
                <p className="text-muted-foreground text-base sm:text-lg font-medium opacity-80 leading-snug">Test your knowledge with your {isFiltered ? 'selected scenarios' : 'entire collection'}.</p>
              </div>
            </div>
          </div>

          <FlashcardsClient initialVocabulary={vocabulary as any} />
        </div>
      </div>
    </div>
  )
